...
class DiscViewer:
    ...
    def _build_ui(self) -> None:
        ...
        self.info_text = self.fig.text(
            0.5,
            0.17,
            "Green = Fiji GT    Red = detected    Yellow = Fiji bbox\n"
    ...
    def _show_current_frame(self) -> None:
        ...
        self.info_text.set_text(
            f"{gt_line}\n{pred_line}\n{err_line}\n"
            "Green = Fiji GT    Red = detected    Yellow = bbox    ← → step"
        )
        self.fig.canvas.draw_idle()
